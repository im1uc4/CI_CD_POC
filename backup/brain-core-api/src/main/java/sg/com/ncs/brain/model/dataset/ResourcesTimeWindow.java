...
@NoArgsConstructor
//@Audited
@Table(name = "resources_time_window")
public class ResourcesTimeWindow extends Audit implements Serializable {

	private static final long serialVersionUID = 59507693787119542L;
